...
urlpatterns = [
    ...
    path('notification/'             , superadmin_views.notification              , name='notification'),
    path('publish/', notification_views.publish_notification, name='publish_notification'),
    path('close/<int:notification_id>/', notification_views.close_notification, name='close_notification'),
    path('view/', notification_views.view_notifications, name='view_notifications'),
